...
public class SaveToLocalQueuesBolt extends BaseRichBolt {
	...
	public void execute(Tuple input) { // , BasicOutputCollector collector
		...
		try {
			...
			jedis.rpush(storm.consume.util.Conf.GetWordCountUrlsQueueName(), storm.consume.util.Serializer.serialize(url));
			jedis.rpush(storm.consume.util.Conf.GetScrnurQueueName(), storm.consume.util.Serializer.serialize(url));
